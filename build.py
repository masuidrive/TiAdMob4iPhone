...
def compile_js(manifest,config):
	js_file = os.path.join(cwd,'assets','jp.masuidrive.ti.admob.js')
	...
	f = os.path.join(cwd,'Classes','JpMasuidriveTiAdmobModuleAssets.m')
	c = open(f).read()
	idx = c.find('return ')
	before = c[0:idx]
	after = """
...
ignoreFiles = ['.DS_Store','.gitignore','libTitanium.a','titanium.jar','README','jp.masuidrive.ti.admob.js']
